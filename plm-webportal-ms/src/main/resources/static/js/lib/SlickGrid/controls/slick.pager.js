(function ($) {
  function SlickGridPager(dataView, grid, $container) {
    ...
    function constructPagerUI() {
      ...
      $settings
          .append("<span class='slick-pager-settings-expanded' style='display:none'>Show: <a data=0>All</a><a data='-1'>Auto</a><a data=100>100</a><a data=500>500</a><a data=1000>1000</a>...</span><span class='autopager' grid='"+gridName+"'><a onclick='loadNextData()'>Load more</a></span>");
